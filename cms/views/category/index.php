        ...
        <div class="row">
                ...
                <div class="left-sidebar">
                    ...
                    <div class="price-range"><!--price-range-->
                        ...
                        <div class="well text-center">
                            ...
                            <b class="pull-left">0 руб</b> <b class="pull-right">10000 руб</b>
                        </div>
                    </div><!--/price-range-->
            ...
            <div class="col-sm-9 padding-right">
                <div class="features_items"><!--features_items-->
                    <h2 class="title text-center">Интернет-магазин</h2>
                    <!--<pre><?//print_r($hits);?></pre>-->
                    <? foreach ($hits as $hit) {?>
                    <div class="col-sm-4">
                        <div class="product-image-wrapper">
                            <div class="single-products">
                                <div class="productinfo text-center">
                                    ...
                                    <? if (empty($hit->img)) {?>
                                        <?=\yii\helpers\Html::img("@web/images/products/no-image.jpg", ['alt' => $hit->name, 'height' => 160]);?>
                                    <?} else {?>
                                    <?=\yii\helpers\Html::img("@web/files/{$hit->img}", ['alt' => $hit->name, 'height' => 160]);?>
                                    <? } ?>
                                    <h2><?=$hit->price;?> руб.</h2>
                            ...
                            <!--<div class="choose">
                                <ul class="nav nav-pills nav-justified">
                                    <li><a href="#"><i class="fa fa-plus-square"></i>В лист желаний</a></li>
                                    <li><a href="#"><i class="fa fa-plus-square"></i>Для сравнения</a></li>
                                </ul>
                            </div>-->
                        </div>
                    </div>
