                ...
                <div class="product-details"><!--product-details-->
                    <div class="col-sm-5">
                        <div class="view-product">
                            ...
                            <? if (empty($product->img)) {?>
                                <?=\yii\helpers\Html::img("@web/images/products/no-image.jpg", ['alt' => $product->name, 'height' => 260]);?>
                            <?} else {?>
                                <?=\yii\helpers\Html::img("@web/files/{$product->img}", ['alt' => $product->name, 'height' => 260]);?>
                            <? } ?>
                            <h3>ZOOM</h3>
                        </div>
                    ...
                    <div class="col-sm-7">
                        <div class="product-information"><!--/product-information-->
                            ...
                            <p><b>Категория:</b> <a href="<?=\yii\helpers\Url::to(['category/view', 'id' => $product->category->id]);?>">
                                                   <?=$product->category->name;?>
                                                 </a>
                            </p>
                            <p><b>Состав:</b> <?=$product->content;?></p>
